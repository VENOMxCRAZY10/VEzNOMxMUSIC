...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO VENOM SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of VENOM Music Started")
    print("[INFO]: STARTED THE VENOM BOT AND SENDING THE INFO TO VENOM SERVER")
